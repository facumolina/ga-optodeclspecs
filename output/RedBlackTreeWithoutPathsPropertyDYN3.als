...
(all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | !((n) in ((n) . (^((left) + (right)))))) and (all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | ((((n) . (left)) . (*((left) + (right)))) & (((n) . (right)) . (*((left) + (right))))) in (Null)) and (eq[(thiz) . (size),#((((thiz) . (root)) . (*((left) + (right)))) - (Null))]) and ((((thiz) . (root)) . (color)) != (Red)) and (all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | (((n) . (color)) = (Red)) => (((((n) . (left)) . (color)) != (Red)) and ((((n) . (right)) . (color)) != (Red))))
}
