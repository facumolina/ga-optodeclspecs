...
pred catalog [thiz: RedBlackTree, root: RedBlackTree ->one (Node + Null), left: Node ->one (Node + Null), right: Node ->one (Node + Null), size: RedBlackTree ->one Int, element: Node ->one Int, color: Node ->one Color] {
/* Acyclic*/
	...
	/* Elem1 */
	(all n:thiz.root.*(left+right)-Null | lte[n.element,0]) and
	/* Color1 */
	(thiz.root.color != Red) and
	/* Color2 */
	(all n : thiz.root.*(left+right)-Null | n.color=Red => ((n.left.color!=Red) and (n.right.color!=Red)))
}

pred repOK [thiz: RedBlackTree, root: RedBlackTree ->one (Node + Null), left: Node ->one (Node + Null), right: Node ->one (Node + Null), size: RedBlackTree ->one Int, element: Node ->one Int, color: Node ->one Color] {
(all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | !((n) in ((n) . (^((left) + (right)))))) and (all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | ((((n) . (left)) . (*((left) + (right)))) & (((n) . (right)) . (*((left) + (right))))) in (Null)) and (!(all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | ((((n) . (left)) . (*((left) + (right)))) & (((n) . (right)) . (*((left) + (right))))) !in (Null))) and (all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | ((#(((n) . (left)) . (*((left) + (right))))) - (#(((n) . (right)) . (*((left) + (right)))))) >= (-1)) and (!(all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | (n) = (((n) . (left)) . (right)))) and (eq[(thiz) . (size),#((((thiz) . (root)) . (*((left) + (right)))) - (Null))]) and (!(eq[(thiz) . (size),sub[#((((thiz) . (root)) . (*((left) + (right)))) - (Null)),1]])) and ((((thiz) . (root)) . (color)) != (Red)) and (all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | (((n) . (color)) = (Red)) => (((((n) . (left)) . (color)) != (Red)) and ((((n) . (right)) . (color)) != (Red))))
}
...
(	SimmetryBreaking[thiz_0, root_0, left_0, right_0, value_0]  and 
	not catalog[thiz_0, root_0, left_0, right_0, size_0, value_0, color_0] and
