...
one sig N0,N1,N2,N3,N4,N5,N6,N7,N8,N9,N10,N11,N12,N13,N14,N15,N16,N17,N18,N19,N20,N21,N22,N23 extends FibHeapIntVarNode {}


one sig i320,i321,i322,i323,i324,i325,i326,i327,i328,i329,i3210,i3211,i3212,i3213,i3214,i3215,i3216,i3217,i3218,i3219,i3220,i3221,i3222,i3223,i3224 extends JavaPrimitiveIntegerValue {} 
fact {
	// int32 bounds 
	b01 in i320->false+i321->false+i322->true+i323->true+i324->false+i325->false+i326->true+i327->true+i328->false+i329->false+i3210->true+i3211->true+i3212->false+i3213->false+i3214->true+i3215->true+i3216->false+i3217->false+i3218->true+i3219->true+i3220->false+i3221->false+i3222->true+i3223->true+i3224->false
	i320->false+i321->false+i322->true+i323->true+i324->false+i325->false+i326->true+i327->true+i328->false+i329->false+i3210->true+i3211->true+i3212->false+i3213->false+i3214->true+i3215->true+i3216->false+i3217->false+i3218->true+i3219->true+i3220->false+i3221->false+i3222->true+i3223->true+i3224->false in b01
	b00 in i320->false+i321->true+i322->false+i323->true+i324->false+i325->true+i326->false+i327->true+i328->false+i329->true+i3210->false+i3211->true+i3212->false+i3213->true+i3214->false+i3215->true+i3216->false+i3217->true+i3218->false+i3219->true+i3220->false+i3221->true+i3222->false+i3223->true+i3224->false
	i320->false+i321->true+i322->false+i323->true+i324->false+i325->true+i326->false+i327->true+i328->false+i329->true+i3210->false+i3211->true+i3212->false+i3213->true+i3214->false+i3215->true+i3216->false+i3217->true+i3218->false+i3219->true+i3220->false+i3221->true+i3222->false+i3223->true+i3224->false in b00
	b05 in i320->false+i321->false+i322->false+i323->false+i324->false+i325->false+i326->false+i327->false+i328->false+i329->false+i3210->false+i3211->false+i3212->false+i3213->false+i3214->false+i3215->false+i3216->false+i3217->false+i3218->false+i3219->false+i3220->false+i3221->false+i3222->false+i3223->false+i3224->false
	i320->false+i321->false+i322->false+i323->false+i324->false+i325->false+i326->false+i327->false+i328->false+i329->false+i3210->false+i3211->false+i3212->false+i3213->false+i3214->false+i3215->false+i3216->false+i3217->false+i3218->false+i3219->false+i3220->false+i3221->false+i3222->false+i3223->false+i3224->false in b05
	b04 in i320->false+i321->false+i322->false+i323->false+i324->false+i325->false+i326->false+i327->false+i328->false+i329->false+i3210->false+i3211->false+i3212->false+i3213->false+i3214->false+i3215->false+i3216->true+i3217->true+i3218->true+i3219->true+i3220->true+i3221->true+i3222->true+i3223->true+i3224->true
	i320->false+i321->false+i322->false+i323->false+i324->false+i325->false+i326->false+i327->false+i328->false+i329->false+i3210->false+i3211->false+i3212->false+i3213->false+i3214->false+i3215->false+i3216->true+i3217->true+i3218->true+i3219->true+i3220->true+i3221->true+i3222->true+i3223->true+i3224->true in b04
	b03 in i320->false+i321->false+i322->false+i323->false+i324->false+i325->false+i326->false+i327->false+i328->true+i329->true+i3210->true+i3211->true+i3212->true+i3213->true+i3214->true+i3215->true+i3216->false+i3217->false+i3218->false+i3219->false+i3220->false+i3221->false+i3222->false+i3223->false+i3224->true
	i320->false+i321->false+i322->false+i323->false+i324->false+i325->false+i326->false+i327->false+i328->true+i329->true+i3210->true+i3211->true+i3212->true+i3213->true+i3214->true+i3215->true+i3216->false+i3217->false+i3218->false+i3219->false+i3220->false+i3221->false+i3222->false+i3223->false+i3224->true in b03
	b02 in i320->false+i321->false+i322->false+i323->false+i324->true+i325->true+i326->true+i327->true+i328->false+i329->false+i3210->false+i3211->false+i3212->true+i3213->true+i3214->true+i3215->true+i3216->false+i3217->false+i3218->false+i3219->false+i3220->true+i3221->true+i3222->true+i3223->true+i3224->false
	i320->false+i321->false+i322->false+i323->false+i324->true+i325->true+i326->true+i327->true+i328->false+i329->false+i3210->false+i3211->false+i3212->true+i3213->true+i3214->true+i3215->true+i3216->false+i3217->false+i3218->false+i3219->false+i3220->true+i3221->true+i3222->true+i3223->true+i3224->false in b02
}
...
pred mysize10[s: set FibHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF10.x24 in s-QF10.x1-QF10.x2-QF10.x3-QF10.x4-QF10.x5-QF10.x6-QF10.x7-QF10.x8-QF10.x9-QF10.x10-QF10.x11-QF10.x12-QF10.x13-QF10.x14-QF10.x15-QF10.x16-QF10.x17-QF10.x18-QF10.x19-QF10.x20-QF10.x21-QF10.x22-QF10.x23 and ((res = i3224 and no s-QF10.x1-QF10.x2-QF10.x3-QF10.x4-QF10.x5-QF10.x6-QF10.x7-QF10.x8-QF10.x9-QF10.x10-QF10.x11-QF10.x12-QF10.x13-QF10.x14-QF10.x15-QF10.x16-QF10.x17-QF10.x18-QF10.x19-QF10.x20-QF10.x21-QF10.x22-QF10.x23-QF10.x24)
	))))))))))))))))))))))))))))))))))))))))))))))))
}
...
pred mysize112[s: set FibHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF112.x24 in s-QF112.x1-QF112.x2-QF112.x3-QF112.x4-QF112.x5-QF112.x6-QF112.x7-QF112.x8-QF112.x9-QF112.x10-QF112.x11-QF112.x12-QF112.x13-QF112.x14-QF112.x15-QF112.x16-QF112.x17-QF112.x18-QF112.x19-QF112.x20-QF112.x21-QF112.x22-QF112.x23 and ((res = i3224 and no s-QF112.x1-QF112.x2-QF112.x3-QF112.x4-QF112.x5-QF112.x6-QF112.x7-QF112.x8-QF112.x9-QF112.x10-QF112.x11-QF112.x12-QF112.x13-QF112.x14-QF112.x15-QF112.x16-QF112.x17-QF112.x18-QF112.x19-QF112.x20-QF112.x21-QF112.x22-QF112.x23-QF112.x24)
	))))))))))))))))))))))))))))))))))))))))))))))))
}
...
pred mysize115[s: set FibHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF115.x24 in s-QF115.x1-QF115.x2-QF115.x3-QF115.x4-QF115.x5-QF115.x6-QF115.x7-QF115.x8-QF115.x9-QF115.x10-QF115.x11-QF115.x12-QF115.x13-QF115.x14-QF115.x15-QF115.x16-QF115.x17-QF115.x18-QF115.x19-QF115.x20-QF115.x21-QF115.x22-QF115.x23 and ((res = i3224 and no s-QF115.x1-QF115.x2-QF115.x3-QF115.x4-QF115.x5-QF115.x6-QF115.x7-QF115.x8-QF115.x9-QF115.x10-QF115.x11-QF115.x12-QF115.x13-QF115.x14-QF115.x15-QF115.x16-QF115.x17-QF115.x18-QF115.x19-QF115.x20-QF115.x21-QF115.x22-QF115.x23-QF115.x24)
	))))))))))))))))))))))))))))))))))))))))))))))))
}
...
pred mysize120[s: set FibHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF120.x24 in s-QF120.x1-QF120.x2-QF120.x3-QF120.x4-QF120.x5-QF120.x6-QF120.x7-QF120.x8-QF120.x9-QF120.x10-QF120.x11-QF120.x12-QF120.x13-QF120.x14-QF120.x15-QF120.x16-QF120.x17-QF120.x18-QF120.x19-QF120.x20-QF120.x21-QF120.x22-QF120.x23 and ((res = i3224 and no s-QF120.x1-QF120.x2-QF120.x3-QF120.x4-QF120.x5-QF120.x6-QF120.x7-QF120.x8-QF120.x9-QF120.x10-QF120.x11-QF120.x12-QF120.x13-QF120.x14-QF120.x15-QF120.x16-QF120.x17-QF120.x18-QF120.x19-QF120.x20-QF120.x21-QF120.x22-QF120.x23-QF120.x24)
	))))))))))))))))))))))))))))))))))))))))))))))))
}
...
pred mysize122[s: set FibHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF122.x24 in s-QF122.x1-QF122.x2-QF122.x3-QF122.x4-QF122.x5-QF122.x6-QF122.x7-QF122.x8-QF122.x9-QF122.x10-QF122.x11-QF122.x12-QF122.x13-QF122.x14-QF122.x15-QF122.x16-QF122.x17-QF122.x18-QF122.x19-QF122.x20-QF122.x21-QF122.x22-QF122.x23 and ((res = i3224 and no s-QF122.x1-QF122.x2-QF122.x3-QF122.x4-QF122.x5-QF122.x6-QF122.x7-QF122.x8-QF122.x9-QF122.x10-QF122.x11-QF122.x12-QF122.x13-QF122.x14-QF122.x15-QF122.x16-QF122.x17-QF122.x18-QF122.x19-QF122.x20-QF122.x21-QF122.x22-QF122.x23-QF122.x24)
	))))))))))))))))))))))))))))))))))))))))))))))))
}
...
run CanSatisfyInvariant for 0 but exactly 1 FibHeapIntVar, exactly 24 FibHeapIntVarNode, 1 int, exactly 25 JavaPrimitiveIntegerValue
