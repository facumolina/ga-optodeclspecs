...
one sig N0,N1,N2,N3 extends BinHeapIntVarNode {}
...
fact { QF.fsibling_0 in N0->N1+N0->N2+N0->N3+N0->null+N1->N2+N1->N3+N1->null+N2->N3+N2->null+N3->null }
...
fact { QF.bsibling_0 in N0->N0+N1->N0+N1->N1+N2->N0+N2->N1+N2->N2+N3->N0+N3->N1+N3->N2+N3->N3 }
...
fact {
	(QF.element_0) in N0->i320+N0->i321+N0->i322+N0->i323+N0->null+N1->i320+N1->i321+N1->i322+N1->i323+N1->null+N2->i320+N2->i321+N2->i322+N2->i323+N2->null+N3->i320+N3->i321+N3->i322+N3->i323+N3->null
}
...
fact {
	(QF.size_0) in BinHeapIntVar->i320+BinHeapIntVar->i321+BinHeapIntVar->i322+BinHeapIntVar->i323+BinHeapIntVar->i324
}
...
one sig QF10 { x1:BinHeapIntVarNode,x2:BinHeapIntVarNode,x3:BinHeapIntVarNode,x4:BinHeapIntVarNode }
...
one sig QF20 { x1:BinHeapIntVarNode,x2:BinHeapIntVarNode,x3:BinHeapIntVarNode,x4:BinHeapIntVarNode }
...
pred mysize20[s: set BinHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF20.x4 in s-QF20.x1-QF20.x2-QF20.x3 and ((res = i324 and no s-QF20.x1-QF20.x2-QF20.x3-QF20.x4)
	))))))))
}
one sig QF30 { x1:BinHeapIntVarNode,x2:BinHeapIntVarNode,x3:BinHeapIntVarNode,x4:BinHeapIntVarNode }
...
pred mysize30[s: set BinHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF30.x4 in s-QF30.x1-QF30.x2-QF30.x3 and ((res = i324 and no s-QF30.x1-QF30.x2-QF30.x3-QF30.x4)
	))))))))
}
one sig QF11 { x1:BinHeapIntVarNode,x2:BinHeapIntVarNode,x3:BinHeapIntVarNode,x4:BinHeapIntVarNode }
...
one sig QF21 { x1:BinHeapIntVarNode,x2:BinHeapIntVarNode,x3:BinHeapIntVarNode,x4:BinHeapIntVarNode }
...
pred mysize21[s: set BinHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF21.x4 in s-QF21.x1-QF21.x2-QF21.x3 and ((res = i324 and no s-QF21.x1-QF21.x2-QF21.x3-QF21.x4)
	))))))))
}
one sig QF31 { x1:BinHeapIntVarNode,x2:BinHeapIntVarNode,x3:BinHeapIntVarNode,x4:BinHeapIntVarNode }
...
pred mysize31[s: set BinHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF31.x4 in s-QF31.x1-QF31.x2-QF31.x3 and ((res = i324 and no s-QF31.x1-QF31.x2-QF31.x3-QF31.x4)
	))))))))
}
one sig QF12 { x1:BinHeapIntVarNode,x2:BinHeapIntVarNode,x3:BinHeapIntVarNode,x4:BinHeapIntVarNode }
...
one sig QF22 { x1:BinHeapIntVarNode,x2:BinHeapIntVarNode,x3:BinHeapIntVarNode,x4:BinHeapIntVarNode }
...
pred mysize22[s: set BinHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF22.x4 in s-QF22.x1-QF22.x2-QF22.x3 and ((res = i324 and no s-QF22.x1-QF22.x2-QF22.x3-QF22.x4)
	))))))))
}
one sig QF32 { x1:BinHeapIntVarNode,x2:BinHeapIntVarNode,x3:BinHeapIntVarNode,x4:BinHeapIntVarNode }
...
pred mysize32[s: set BinHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF32.x4 in s-QF32.x1-QF32.x2-QF32.x3 and ((res = i324 and no s-QF32.x1-QF32.x2-QF32.x3-QF32.x4)
	))))))))
}
one sig QF13 { x1:BinHeapIntVarNode,x2:BinHeapIntVarNode,x3:BinHeapIntVarNode,x4:BinHeapIntVarNode }
...
one sig QF23 { x1:BinHeapIntVarNode,x2:BinHeapIntVarNode,x3:BinHeapIntVarNode,x4:BinHeapIntVarNode }
...
pred mysize23[s: set BinHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF23.x4 in s-QF23.x1-QF23.x2-QF23.x3 and ((res = i324 and no s-QF23.x1-QF23.x2-QF23.x3-QF23.x4)
	))))))))
}
one sig QF33 { x1:BinHeapIntVarNode,x2:BinHeapIntVarNode,x3:BinHeapIntVarNode,x4:BinHeapIntVarNode }
...
pred mysize33[s: set BinHeapIntVarNode, res: JavaPrimitiveIntegerValue] {
	 ...
	 (QF33.x4 in s-QF33.x1-QF33.x2-QF33.x3 and ((res = i324 and no s-QF33.x1-QF33.x2-QF33.x3-QF33.x4)
	))))))))
}


pred CanSatisfyInvariant[] {}
run CanSatisfyInvariant for 0 but exactly 1 BinHeapIntVar, exactly 4 BinHeapIntVarNode, 1 int, exactly 5 JavaPrimitiveIntegerValue
