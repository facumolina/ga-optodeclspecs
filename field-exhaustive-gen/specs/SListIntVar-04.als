...
one sig N0,N1,N2,N3 extends SListIntVarNode {}
...
fact {
	(QF.nodeValue_0) in N0->i320+N0->i321+N0->i322+N0->null+N1->i320+N1->i321+N1->i322+N1->null+N2->i320+N2->i321+N2->i322+N2->null+N3->i320+N3->i321+N3->i322+N3->null
}


fact {
	(QF.size_0) in SListIntVar->i320+SListIntVar->i321+SListIntVar->i322+SListIntVar->i323
}
...
run CanSatisfyInvariant for 0 but exactly 1 SListIntVar, exactly 4 SListIntVarNode, 1 int, exactly 4 JavaPrimitiveIntegerValue
