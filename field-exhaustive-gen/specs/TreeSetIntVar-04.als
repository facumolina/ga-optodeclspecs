...
let entry=(QF.thiz_0).(QF.root_0),ff1=QF.fleft_0,ff2=QF.fright_0,ff3=QF.fparent_0,bf1=QF.bleft_0,bf2=QF.bright_0,bf3=QF.bparent_0 | { 
   ...
   N0+N1+N2+N3 = ff2.univ + bf2.univ   
   N0+N1+N2+N3 = ff3.univ + bf3.univ   
...
one sig N0,N1,N2,N3 extends TreeSetIntVarNode {}
...
fact {
	(QF.size_0) in TreeSetIntVar->i320+TreeSetIntVar->i321+TreeSetIntVar->i322+TreeSetIntVar->i323+TreeSetIntVar->i324
}


fact {
	(QF.blackHeight_0) in N0->i320+N0->i321+N0->i322+N0->i323+N0->null+N1->i320+N1->i321+N1->i322+N1->i323+N1->null+N2->i320+N2->i321+N2->i322+N2->i323+N2->null+N3->i320+N3->i321+N3->i322+N3->i323+N3->null
}
...
run CanSatisfyInvariant for 0 but exactly 1 TreeSetIntVar, exactly 4 TreeSetIntVarNode, 1 int, exactly 5 JavaPrimitiveIntegerValue
