...
let entry=(QF.thiz_0).(QF.root_0),ff1=QF.fleft_0,ff2=QF.fright_0,ff3=QF.fparent_0,bf1=QF.bleft_0,bf2=QF.bright_0,bf3=QF.bparent_0 | { 
   ...
   N0+N1+N2+N3+N4+N5+N6+N7+N8+N9+N10+N11+N12+N13+N14+N15+N16 = ff3.univ + bf3.univ   
...
one sig N0,N1,N2,N3,N4,N5,N6,N7,N8,N9,N10,N11,N12,N13,N14,N15,N16 extends TreeSetIntVarNode {}
...
run CanSatisfyInvariant for 0 but exactly 1 TreeSetIntVar, exactly 17 TreeSetIntVarNode, 1 int, exactly 18 JavaPrimitiveIntegerValue
