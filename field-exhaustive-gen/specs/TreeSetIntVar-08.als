...
let entry=(QF.thiz_0).(QF.root_0),ff1=QF.fleft_0,ff2=QF.fright_0,ff3=QF.fparent_0,bf1=QF.bleft_0,bf2=QF.bright_0,bf3=QF.bparent_0 | { 
   ...
   N0+N1+N2+N3+N4+N5+N6+N7 = ff2.univ + bf2.univ   
   N0+N1+N2+N3+N4+N5+N6+N7 = ff3.univ + bf3.univ   
...
one sig N0,N1,N2,N3,N4,N5,N6,N7 extends TreeSetIntVarNode {}
...
fact {
	(QF.size_0) in TreeSetIntVar->i320+TreeSetIntVar->i321+TreeSetIntVar->i322+TreeSetIntVar->i323+TreeSetIntVar->i324+TreeSetIntVar->i325+TreeSetIntVar->i326+TreeSetIntVar->i327+TreeSetIntVar->i328
}
...
run CanSatisfyInvariant for 0 but exactly 1 TreeSetIntVar, exactly 8 TreeSetIntVarNode, 1 int, exactly 9 JavaPrimitiveIntegerValue
