...
one sig N0,N1,N2,N3 extends BSTreeIntVarNode {}
...
fact {
	(QF.size_0) in BSTreeIntVar->i320+BSTreeIntVar->i321+BSTreeIntVar->i322+BSTreeIntVar->i323+BSTreeIntVar->i324
}
...
run CanSatisfyInvariant for 0 but exactly 1 BSTreeIntVar, exactly 4 BSTreeIntVarNode, 1 int, exactly 5 JavaPrimitiveIntegerValue
