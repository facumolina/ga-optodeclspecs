...
one sig N0,N1,N2,N3,N4,N5,N6,N7,N8,N9,N10 extends SListIntVarNode {}
...
fact {
	let m = node_max[FReach[]-null], size = (QF.thiz_0).(QF.size_0) | 
	  ...
	  (m = N10 and size = i3210)
}


pred CanSatisfyInvariant[] {}
run CanSatisfyInvariant for 0 but exactly 1 SListIntVar, exactly 11 SListIntVarNode, 1 int, exactly 11 JavaPrimitiveIntegerValue
