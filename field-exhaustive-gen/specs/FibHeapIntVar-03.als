...
one sig N0,N1,N2 extends FibHeapIntVarNode {}
...
fact { QF.fright_0 in N0->N1+N0->N2+N0->null+N1->N2+N1->null+N2->null }
fact { QF.fleft_0 in N0->N1+N0->N2+N0->null+N1->N2+N1->null+N2->null }
...
fact { QF.bright_0 in N0->N0+N1->N0+N1->N1+N2->N0+N2->N1+N2->N2 }
fact { QF.bleft_0 in N0->N0+N1->N0+N1->N1+N2->N0+N2->N1+N2->N2 }
fact { QF.bchild_0 in N0->N0+N1->N0+N1->N1+N2->N0+N2->N1+N2->N2 }
fact { QF.bparent_0 in N0->N0+N1->N0+N1->N1+N2->N0+N2->N1+N2->N2 }


fact {
	(QF.key_0) in N0->i320+N0->i321+N0->i322+N0->null+N1->i320+N1->i321+N1->i322+N1->null+N2->i320+N2->i321+N2->i322+N2->null
}
...
fact {
	(QF.size_0) in FibHeapIntVar->i320+FibHeapIntVar->i321+FibHeapIntVar->i322+FibHeapIntVar->i323
}
...
one sig QF10 { x1:FibHeapIntVarNode,x2:FibHeapIntVarNode,x3:FibHeapIntVarNode }
...
one sig QF11 { x1:FibHeapIntVarNode,x2:FibHeapIntVarNode,x3:FibHeapIntVarNode }
...
one sig QF12 { x1:FibHeapIntVarNode,x2:FibHeapIntVarNode,x3:FibHeapIntVarNode }
...
run CanSatisfyInvariant for 0 but exactly 1 FibHeapIntVar, exactly 3 FibHeapIntVarNode, 1 int, exactly 4 JavaPrimitiveIntegerValue
