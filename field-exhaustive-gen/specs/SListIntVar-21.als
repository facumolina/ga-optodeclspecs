...
one sig N0,N1,N2,N3,N4,N5,N6,N7,N8,N9,N10,N11,N12,N13,N14,N15,N16,N17,N18,N19,N20 extends SListIntVarNode {}
...
fact {
	let m = node_max[FReach[]-null], size = (QF.thiz_0).(QF.size_0) | 
	  ...
	  (m = N20 and size = i3220)
}


pred CanSatisfyInvariant[] {}
run CanSatisfyInvariant for 0 but exactly 1 SListIntVar, exactly 21 SListIntVarNode, 1 int, exactly 21 JavaPrimitiveIntegerValue
