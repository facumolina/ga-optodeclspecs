...
(all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | !((n) in ((n) . (^((left) + (right)))))) and (all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | ((((n) . (left)) . (*((left) + (right)))) & (((n) . (right)) . (*((left) + (right))))) in (Null)) and (all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | ((#(((n) . (left)) . (*((left) + (right))))) - (#(((n) . (right)) . (*((left) + (right)))))) >= (-1)) and (all n : one(((thiz) . (root)) . (*((left) + (right)))) | ((((n) . (left)) != (Null)) => (gte[(n) . (element),((n) . (left)) . (element)])) and ((((n) . (right)) != (Null)) => (gte[(n) . (element),((n) . (right)) . (element)])))
}
