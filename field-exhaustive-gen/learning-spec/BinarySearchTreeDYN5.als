...
pred repOK [
	...
	size: BinaryTree ->one Int, 
	element: TreeNode ->one Int] {
(all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | !((n) in ((n) . (^((left) + (right)))))) and (eq[(thiz) . (size),#((((thiz) . (root)) . (*((left) + (right)))) - (Null))]) and (!(eq[(thiz) . (size),sub[#((((thiz) . (root)) . (*((left) + (right)))) - (Null)),1]])) and (!(all n : one(((thiz) . (root)) . (*((left) + (right)))) | ((((n) . (left)) != (Null)) => (lte[((n) . (left)) . (element),(n) . (element)])) and ((((n) . (right)) != (Null)) => (gt[((n) . (right)) . (element),(n) . (element)])))) and (all n : one(((thiz) . (root)) . (*((left) + (right)))) | (all x : one((((n) . (left)) . (*((left) + (right)))) - (Null)) | lt[(x) . (element),(n) . (element)]) and (all x : one((((n) . (right)) . (*((left) + (right)))) - (Null)) | gte[(x) . (element),(n) . (element)]))
}
