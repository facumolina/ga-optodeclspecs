...
(!(all n : one((((thiz) . (header)) . (*((next) + (previous)))) - (Null)) | !((n) in ((n) . (^((next) + (previous))))))) and (all n : one((((thiz) . (header)) . (*((next) + (previous)))) - (Null)) | (n) = (((n) . (next)) . (previous))) and (eq[(thiz) . (size),#(((thiz) . (header)) . (*((next) + (previous))))]) and (!(eq[(thiz) . (size),sub[#((((thiz) . (header)) . (*((next) + (previous)))) - (Null)),1]]))
}
