...
-- Catalog
pred catalog [thiz: Dag, root: Dag ->one (Node + Null), left: Node ->one (Node + Null), right: Node ->one (Node + Null), size: Dag ->one Int,element: Node ->one Int] {
/* Acyclic*/
...
pred repOK [thiz: Dag, root: Dag ->one (Node + Null), left: Node ->one (Node + Null), right: Node ->one (Node + Null), size: Dag ->one Int,element: Node ->one Int] {
(all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | !((n) in ((n) . (^((left) + (right)))))) and (!(all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | ((((n) . (left)) . (*((left) + (right)))) & (((n) . (right)) . (*((left) + (right))))) !in (Null))) and (((thiz) . (root)) != (Null)) and (eq[(thiz) . (size),#((((thiz) . (root)) . (*((left) + (right)))) - (Null))])
}
...
pred sourceRepOK [thiz_0: Dag, root_0: Dag ->one (Node + Null), left_0: Node ->one (Node + Null), right_0: Node ->one (Node + Null), size_0: Dag ->one Int, element: Node ->one Int, result_0, result_1, result_2, result_3, result_4, result_5, result_6, result_7, result_8: boolean] {
...
pred symmetryBreaking[
	...
	all n : Node - thiz.root.*(left + right) | n.left = Null and n.right = Null and eq[n.element,0]
}
...
pred NegativeCounterExample [thiz_0: Dag, root_0: Dag ->one (Node + Null), left_0: Node ->one (Node + Null), right_0: Node ->one (Node + Null), size_0: Dag ->one Int, element: Node ->one Int] {
(symmetryBreaking[thiz_0, root_0, left_0, right_0,element] and repOK[thiz_0, root_0, left_0, right_0, size_0, element] and  (sourceRepOK[thiz_0, root_0, left_0, right_0, size_0, element, QFNegativeCounterExample.result_0, QFNegativeCounterExample.result_1, QFNegativeCounterExample.result_2, QFNegativeCounterExample.result_3, QFNegativeCounterExample.result_4, QFNegativeCounterExample.result_5, QFNegativeCounterExample.result_6, QFNegativeCounterExample.result_7, QFNegativeCounterExample.result_8] and QFNegativeCounterExample.result_8= false )
 ) 
}
...
pred PositiveCounterExample [thiz_0: Dag, root_0: Dag ->one (Node + Null), left_0: Node ->one (Node + Null), right_0: Node ->one (Node + Null), size_0: Dag ->one Int, element: Node ->one Int] {
(symmetryBreaking[thiz_0, root_0, left_0, right_0,element] and not catalog[thiz_0, root_0, left_0, right_0, size_0,element] and some 	result_0, result_1, result_2, result_3, result_4, result_5, result_6, result_7, result_8: one boolean | { 
(sourceRepOK[thiz_0, root_0, left_0, right_0, size_0, element, result_0, result_1, result_2, result_3, result_4, result_5, result_6, result_7, result_8] and result_8 = true )}
 ) 
}
