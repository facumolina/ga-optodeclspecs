...
pred repOK [
	...
	size: BinaryTree ->one Int, 
	element: TreeNode ->one Int] {
(all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | !((n) in ((n) . (^((left) + (right)))))) and (!(all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | ((thiz) . (root)) in ((n) . ((left) + (right))))) and (all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | ((((n) . (left)) . (*((left) + (right)))) & (((n) . (right)) . (*((left) + (right))))) in (Null)) and (all n : one((((thiz) . (root)) . (*((left) + (right)))) - (Null)) | ((#(((n) . (left)) . (*((left) + (right))))) - (#(((n) . (right)) . (*((left) + (right)))))) >= (-1))
}
