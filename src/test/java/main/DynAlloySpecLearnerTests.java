...
public class DynAlloySpecLearnerTests {
	...
	public void testLinkedList() throws Exception {
		DynAlloySpecLearner learner = new DynAlloySpecLearner("src/test/resources/specs/linked-lists-invariants.als");
		learner.learnSpec();
	...
	public void testApacheList() throws Exception {
		DynAlloySpecLearner learner = new DynAlloySpecLearner("src/test/resources/specs/ApacheList.als");
		learner.learnSpec();
		String result = learner.learnedSpec();
		assertTrue(result != null);
		System.out.println(result);
	...
	public void testAvlTree() throws Exception {
		DynAlloySpecLearner learner = new DynAlloySpecLearner("src/test/resources/specs/avl-tree.als");
		learner.learnSpec();
		String result = learner.learnedSpec();
		assertTrue(result != null);
		System.out.println(result);
	...
	public void testLinkedListSpec() throws Exception {
		DynAlloySpecLearner learner = new DynAlloySpecLearner("src/test/resources/specs/linked-lists-spec.als");
	...
	public void testLinkedListScope3() throws Exception {
		DynAlloySpecLearner learner = new DynAlloySpecLearner("src/test/resources/sbst2018/LinkedListScope3.als");
		learner.learnSpecFromSpec();
		String result = learner.learnedSpec();
		assertTrue(result != null);
		System.out.println(result);
	...
	public void testLinkedListEmptySpec() throws Exception {	
		DynAlloySpecLearner learner = new DynAlloySpecLearner("src/test/resources/specs/linked-lists-empty-spec.als");
	...
	public void testBinaryTreeSpec() throws Exception {
		DynAlloySpecLearner learner = new DynAlloySpecLearner("src/test/resources/specs/binary-tree-spec.als");
		learner.learnSpecFromSpec();
		String result = learner.learnedSpec();
		assertTrue(result != null);
		System.out.println(result);
	...
	public void testBinaryTreeEmptySpec() throws Exception {
		DynAlloySpecLearner learner = new DynAlloySpecLearner("src/test/resources/specs/binary-tree-empty-spec.als");
		learner.learnSpecFromEmptySpec();
		String genes = learner.learnedSpecFromEmptySpec();
		assertTrue(genes != null);
		System.out.println("Learned Spec:");
	...
	public void testSinglyLinkedListDYN3() throws Exception {		
		int r = SpecTranslator.processFile("src/test/resources/specs/SinglyLinkedListDYN3.als");
		assertTrue(r == 1);
	}
	...
	public void testSinglyLinkedListDYN3Instances() throws Exception {		
		int r = SpecTranslator.processFile("src/test/resources/specs/SinglyLinkedListDYN3Instances.als");
		assertTrue(r == 1);
	}
	...
	public void testSinglyLinkedListDYN5() throws Exception {	
		int r = SpecTranslator.processFile("src/test/resources/specs/SinglyLinkedListDYN5.als");
		assertTrue(r == 1);
	}
	...
	public void testSinglyLinkedListDYN8() throws Exception {	
		int r = SpecTranslator.processFile("src/test/resources/specs/SinglyLinkedListDYN8.als");
		assertTrue(r == 1);
	}
	...
	public void testSinglyLinkedListDYN10() throws Exception {	
		int r = SpecTranslator.processFile("src/test/resources/specs/SinglyLinkedListDYN10.als");
		assertTrue(r == 1);
	}
	...
	public void testSinglySortedLinkedListDYN3() throws Exception {	
		...
		int r = SpecTranslator.processFile("src/test/resources/specs/SinglySortedLinkedListDYN3.als",params);
		assertTrue(r == 1);
	}
	...
	public void testBinaryTreeDYN3() throws Exception {	
		int r = SpecTranslator.processFile("src/test/resources/specs/BinaryTreeDYN3.als");
		assertTrue(r == 1);
	}
	...
	public void testBinaryTreeDYN5() throws Exception {	
		int r = SpecTranslator.processFile("src/test/resources/specs/BinaryTreeDYN5.als");
		assertTrue(r == 1);
	}
	...
	public void testBinarySearchTreeDYN5() throws Exception {	
		int r = SpecTranslator.processFile("src/test/resources/specs/BinarySearchTreeDYN5.als");
		assertTrue(r == 1);
	}
	...
	public void testRedBlackTreeWithoutPathsPropertyDYN3() throws Exception {
		...
		int r = SpecTranslator.processFile("src/test/resources/specs/RedBlackTreeWithoutPathsPropertyDYN3.als");
		assertTrue(r == 1);
	}
	...
	public void testRedBlackTreeWithoutPathsPropertyDYN5() throws Exception {
		ConfigurationProperties.setIntEvaluations("false");
		int r = SpecTranslator.processFile("src/test/resources/specs/RedBlackTreeWithoutPathsPropertyDYN5.als");
		assertTrue(r == 1);
	}
	...
	public void testBinaryHeapDYN3() throws Exception {	
		int r = SpecTranslator.processFile("src/test/resources/specs/BinaryHeapDYN3.als");
		assertTrue(r == 1);
	}
	...
	public void testDagDYN3() throws Exception {	
		int r = SpecTranslator.processFile("src/test/resources/specs/DagDYN3.als");
		assertTrue(r == 1);
	}
	...
	public void testSinglyCircularListDYN3() throws Exception {	
		int r = SpecTranslator.processFile("src/test/resources/specs/SinglyCircularListDYN3.als");
		assertTrue(r == 1);
	}
	...
	public void testDoublyLinkedListDYN3() throws Exception {	
		int r = SpecTranslator.processFile("src/test/resources/specs/DoublyLinkedListDYN3.als");
		assertTrue(r == 1);
	}
	...
	public void testDoublyLinkedListDYN5() throws Exception {	
		int r = SpecTranslator.processFile("src/test/resources/specs/DoublyLinkedListDYN5.als");
		assertTrue(r == 1);
	}
