...
pred PositiveCounterExample[thiz: List, header_0: List ->one (Node + Null), size_0: List ->one Int, next_0: Node ->one (Node + Null),element_0: Node ->one Int] {
	symmetryBreaking[header_0, next_0,element_0] and not catalog[thiz, header_0, size_0, next_0,element_0] and some result_0, result_1,result_2,result_3,result_4,result_5: boolean | sourceRepOK [thiz, header_0, size_0, next_0, element_0,result_0, result_1, result_2, result_3, result_4, result_5] and result_5 = true
}
